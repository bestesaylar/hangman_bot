...
class HangmanGame {
    ...
    newGame(msg) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField('How To Play', "React to this message using the emojis like letters (🅰️, 🇹, )")
            .setTimestamp();
    ...
    gameOver(win) {
        ...
        const editEmbed = new Discord.MessageEmbed()
            .setColor('#db9a00')
            .setTitle('Hangman')
            .setDescription((win ? "Thank you for saving my life!💗" : "Taking someoe's life shouldn't be this easy...") + "\n\nThe Word was:\n" + this.word)
            .setTimestamp();
        this.gameEmbed.edit(editEmbed);
